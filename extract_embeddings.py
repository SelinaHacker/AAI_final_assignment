...
def get_embedding(text, model="model-identifier"):
    ...
    print(f"Generated embedding for text: {text[:50]}...")  # Debugging output
    return embedding
...
def process_csv(input_file, output_file, model="model-identifier"):
    with open(input_file, mode='r', newline='', encoding='utf-8') as infile, open(output_file, mode='w', newline='', encoding='utf-8') as outfile:
        ...
        print(f"Processed first message from {agent_name}")  # Debugging output
        ...
        for row in reader:
            ...
            print(f"Processed message from {agent_name}")  # Debugging output
